 Developed an Amazon clone web application using HTML and CSS in Visual Studio Code. The project includes a responsive design with features such as product listings, a search
